...
// MERIDIAN HAYATE — ATTITUDE SQUADRON collection, development build.
//
...
android {
    namespace = "com.xsytrance.squadron.hayate.dev"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.xsytrance.squadron.hayate.dev"
        minSdk = 34
        targetSdk = 36
        versionCode = 1
