...
The flagship. Deep IJA fighter green over a riveted fuselage panel, natural-metal spinner, red squadron bar.
...
| | |
|---|---|
| Package | `com.xsytrance.squadron.hayate.dev` |
| Version | `0.1.0-dev` (versionCode 1) |
| Dial mark | MERIDIAN / HAYATE |
| Markers | military |
...
```bash
python3 tools/squadron_scaffold.py --only hayate
python3 tools/generate_face.py squadron-hayate
tools/build_face.sh squadron-hayate
```
