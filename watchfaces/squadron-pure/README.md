...
The public flagship. Restrained anthracite sunburst, polished applied indices, no weathering, nothing shouting.
...
| | |
|---|---|
| Package | `com.xsytrance.squadron.pure.dev` |
| Version | `0.1.0-dev` (versionCode 1) |
| Dial mark | MERIDIAN / ATTITUDE |
| Markers | applied |
...
python3 tools/generate_face.py squadron-pure
tools/build_face.sh squadron-pure
```
