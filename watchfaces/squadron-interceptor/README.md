# MERIDIAN INTERCEPTOR

Blacked-out night fighter. Gunmetal case, near-black panel dial, cold white lume, minimal colour.
...
| | |
|---|---|
| Package | `com.xsytrance.squadron.interceptor.dev` |
| Version | `0.1.0-dev` (versionCode 1) |
| Dial mark | MERIDIAN / INTERCEPTOR |
| Markers | applied |
...
```bash
python3 tools/squadron_scaffold.py --only interceptor
python3 tools/generate_face.py squadron-interceptor
tools/build_face.sh squadron-interceptor
```
