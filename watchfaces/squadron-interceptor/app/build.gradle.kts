...
// MERIDIAN INTERCEPTOR — ATTITUDE SQUADRON collection, development build.
//
...
android {
    namespace = "com.xsytrance.squadron.interceptor.dev"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.xsytrance.squadron.interceptor.dev"
        minSdk = 34
        targetSdk = 36
        versionCode = 1
