...
// MERIDIAN RADIAL — ATTITUDE SQUADRON collection, development build.
//
...
android {
    namespace = "com.xsytrance.squadron.radial.dev"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.xsytrance.squadron.radial.dev"
        minSdk = 34
        targetSdk = 36
        versionCode = 1
