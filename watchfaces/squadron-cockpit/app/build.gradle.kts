...
// MERIDIAN COCKPIT — ATTITUDE SQUADRON collection, development build.
//
...
android {
    namespace = "com.xsytrance.squadron.cockpit.dev"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.xsytrance.squadron.cockpit.dev"
        minSdk = 34
        targetSdk = 36
        versionCode = 1
