# XSY PULSE (`com.xsytrance.pulseface`, WFF v4)

Pulse-driven face (label "XSY PULSE"). Released: `releases/pulseface/`
(preview.png there shows the design).

## Build & install

```bash
# from repo root
tools/build_face.sh pulseface          # or: cd watchfaces/pulseface && JAVA_HOME=<jdk21> ./gradlew assembleDebug
