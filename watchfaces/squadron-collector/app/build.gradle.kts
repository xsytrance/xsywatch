...
// MERIDIAN COLLECTOR — ATTITUDE SQUADRON collection, development build.
//
...
android {
    namespace = "com.xsytrance.squadron.collector.dev"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.xsytrance.squadron.collector.dev"
        minSdk = 34
        targetSdk = 36
        versionCode = 1
