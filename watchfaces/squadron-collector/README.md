...
Everything unnecessary removed. Bare dial, hairline markers, the propeller hands carrying the whole design.
...
| | |
|---|---|
| Package | `com.xsytrance.squadron.collector.dev` |
| Version | `0.1.0-dev` (versionCode 1) |
| Dial mark | MERIDIAN / COLLECTOR |
| Markers | minimal |
...
```bash
python3 tools/squadron_scaffold.py --only collector
python3 tools/generate_face.py squadron-collector
tools/build_face.sh squadron-collector
```
