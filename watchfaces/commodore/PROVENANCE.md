# PROVENANCE — MERIDIAN COMMODORE

**Generated assets in this project cannot ship.**

| Asset | Origin | Ships? |
|---|---|---|
| `cm_dial.png`, `cm_dial_aod.png` | Flux Kontext Pro over a procedural layout | **No** |
| `cm_hour.png`, `cm_minute.png` | Flux Kontext Pro, chroma-keyed and re-registered | **No** |
| `cm_canopy.png` | Flux Kontext Pro, keyed and masked to the aperture | **No** |
| `cm_disc.png` | derived — a motion blur of the generated shell | **No** (derived from generated) |
| `cm_hub`, needles, `m_*` glyphs | procedural | yes |
| `watchface.xml` | generated from `engine/face.toml` | yes |
| `cm_ov_rain/storm/snow/cloud/stars/flash.png` | procedural — seeded drawing, `tools/make_weather_overlays.py` | **yes** |
| `cm_wx_clip.png` | derived — `cm_dial.png` with the window silhouette punched out, `tools/make_window_clips.py` | **No** (derived from generated) |
...
deterministic and lives at `pipeline/commodore_layout.py` in the studio repo.
