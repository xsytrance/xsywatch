...
hinomaru, navy lacquer blades with gold tips, and a gunsight canopy looking out at the world.

**Development build** — see [`PROVENANCE.md`](PROVENANCE.md).

| | |
|---|---|
| Package | `com.xsytrance.commodore.dev` |
| Version | `0.1.0-dev` |
...
```bash
python3 tools/generate_face.py commodore
bash tools/wff_validate.sh 4 watchfaces/commodore/app/src/main/res/raw/watchface.xml
bash tools/build_face.sh commodore
```
