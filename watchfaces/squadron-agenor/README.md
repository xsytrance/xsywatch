...
Internal build carrying the house mark. Excluded from the public collection by the branding rule.
...
| | |
|---|---|
| Package | `com.xsytrance.squadron.agenor.dev` |
| Version | `0.1.0-dev` (versionCode 1) |
| Dial mark | AGENOR / MERIDIAN |
| Markers | applied |
...
```bash
python3 tools/squadron_scaffold.py --only agenor
python3 tools/generate_face.py squadron-agenor
tools/build_face.sh squadron-agenor
```
