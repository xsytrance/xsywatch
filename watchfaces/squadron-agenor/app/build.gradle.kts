...
// ATTITUDE AGENOR — ATTITUDE SQUADRON collection, development build.
//
...
android {
    namespace = "com.xsytrance.squadron.agenor.dev"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.xsytrance.squadron.agenor.dev"
        minSdk = 34
        targetSdk = 36
        versionCode = 1
