...
Trainer-scheme yellow with black chequer accents. The brightest face in the family and still premium.
...
| | |
|---|---|
| Package | `com.xsytrance.squadron.trainer.dev` |
| Version | `0.1.0-dev` (versionCode 1) |
| Dial mark | MERIDIAN / TRAINER |
| Markers | military |
...
```bash
python3 tools/squadron_scaffold.py --only trainer
python3 tools/generate_face.py squadron-trainer
tools/build_face.sh squadron-trainer
```
