...
// MERIDIAN TRAINER — ATTITUDE SQUADRON collection, development build.
//
...
android {
    namespace = "com.xsytrance.squadron.trainer.dev"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.xsytrance.squadron.trainer.dev"
        minSdk = 34
        targetSdk = 36
        versionCode = 1
