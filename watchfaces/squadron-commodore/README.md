...
The most sellable. Deep navy sunburst, warm gold furniture, polished indices — the one that photographs best.
...
| | |
|---|---|
| Package | `com.xsytrance.squadron.commodore.dev` |
| Version | `0.1.0-dev` (versionCode 1) |
| Dial mark | MERIDIAN / COMMODORE |
| Markers | applied |
...
```bash
python3 tools/squadron_scaffold.py --only commodore
python3 tools/generate_face.py squadron-commodore
tools/build_face.sh squadron-commodore
```
