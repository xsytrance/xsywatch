...
// MERIDIAN COMMODORE — ATTITUDE SQUADRON collection, development build.
//
...
android {
    namespace = "com.xsytrance.squadron.commodore.dev"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.xsytrance.squadron.commodore.dev"
        minSdk = 34
        targetSdk = 36
        versionCode = 1
