...
Balsa flyer nostalgia. Warm paper-card dial, red and yellow printed livery, cheerful but built like an instrument.
...
| | |
|---|---|
| Package | `com.xsytrance.squadron.balsa.dev` |
| Version | `0.1.0-dev` (versionCode 1) |
| Dial mark | MERIDIAN / BALSA |
| Markers | stencil |
...
```bash
python3 tools/squadron_scaffold.py --only balsa
python3 tools/generate_face.py squadron-balsa
tools/build_face.sh squadron-balsa
```
