...
// MERIDIAN HERITAGE — ATTITUDE SQUADRON collection, development build.
//
...
android {
    namespace = "com.xsytrance.squadron.heritage.dev"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.xsytrance.squadron.heritage.dev"
        minSdk = 34
        targetSdk = 36
        versionCode = 1
