# PROVENANCE — MERIDIAN PURE

**Generated assets in this project cannot ship.**

| Asset | Origin | Ships? |
|---|---|---|
| `pu_dial.png`, `pu_dial_aod.png` | Flux Kontext Pro over a procedural layout | **No** |
| `pu_hour.png`, `pu_minute.png` | Flux Kontext Pro, chroma-keyed and re-registered | **No** |
| `pu_canopy.png` | Flux Kontext Pro, keyed and masked to the aperture | **No** |
| `pu_disc.png` | derived — a motion blur of the generated shell | **No** (derived from generated) |
| `pu_hub`, needles, `m_*` glyphs | procedural | yes |
| `watchface.xml` | generated from `engine/face.toml` | yes |
| `pu_ov_rain/storm/snow/cloud/stars/flash.png` | procedural — seeded drawing, `tools/make_weather_overlays.py` | **yes** |
| `pu_wx_clip.png` | derived — `pu_dial.png` with the window silhouette punched out, `tools/make_window_clips.py` | **No** (derived from generated) |
...
deterministic and lives at `pipeline/pure_layout.py` in the studio repo.
