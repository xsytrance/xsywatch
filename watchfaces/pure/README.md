...
hinomaru, machined steel blades, and a gunsight canopy looking out at the world.

**Development build** — see [`PROVENANCE.md`](PROVENANCE.md).

| | |
|---|---|
| Package | `com.xsytrance.pure.dev` |
| Version | `0.1.0-dev` |
...
```bash
python3 tools/generate_face.py pure
bash tools/wff_validate.sh 4 watchfaces/pure/app/src/main/res/raw/watchface.xml
bash tools/build_face.sh pure
```
