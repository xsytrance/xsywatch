# rc1 physical Watch7 validation — BLOCKED
...
2. `adb install -r releases/aurelius/candidates/2.0.0-rc1/aurelius-2.0.0-rc1-debug.apk`
...
4. Record wear sessions against the rc1 APK hash
   `d02bf91494f94abb5176685baea19b6e788dbd5c92d0df50c4bfde14d00c7956`
